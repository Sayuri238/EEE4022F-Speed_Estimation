...
for r = 1:NumCols
    ...
    [detectCol, numberOfDetections] = Sayuri_CACFAR(RefWindow, guardCells, sliderLen, PFA, DataAfterPowerLawDetector_column, extended_NumRows, CUT_index);
...
PFA_error = ((PFA - PFA_Simulation)/PFA) * 100 
